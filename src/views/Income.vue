      ...
      <div class="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="space-y-1">
            ...
            <textarea v-model="newIncome.description" rows="3" class="w-full rounded-lg border border-slate-200 px-3 py-2 focus:border-purdue-gold focus:ring-1 focus:ring-purdue-gold"></textarea>
          </div>
